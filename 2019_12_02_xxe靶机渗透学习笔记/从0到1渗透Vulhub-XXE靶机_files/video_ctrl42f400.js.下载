...
if(!(Math.random()<.999)){
var n=9;
"https:"===window.location.protocol&&(n=18),G.saveSpeeds({
uin:window.uin,
pid:n,
speeds:[{
sid:29,
...
n.src=lt.idkey?"/mp/jsmonitor?idkey="+lt.idkey+"_"+e+"_1&t="+o:"/mp/jsreport?key="+e+"&content="+t+"&r="+o;
}
}
function p(){
_t||(_t=!0,new Y({
...
e.innerHTML=Ft.encode(e.innerHTML);
});
}
function y(e,t,n){
...
if(i=e[l],i.time=g(i.create_time),i.status="",i.logo_url=i.logo_url||Ot,i.logo_url=-1!==i.logo_url.indexOf("wx.qlogo.cn")?i.logo_url.replace(/\/132$/,"/96"):i.logo_url,
...
c.time=g(c.create_time),c.content=(c.content||"").htmlEncodeLite(),c.reply_like_status=c.reply_like_status||0,
...
"en"===window.LANG&&(c.reply_like_num_format=et.dealLikeReadShow_en(c.reply_like_num));
}
i.new_appmsg=window.new_appmsg,m+=ot.tmpl(W,i);
try{
var s=i.nick_name+i.content,r=!1,p=lt.repeatContentID;
Tt[s]&&(r=!0,p=lt.repeatContent),Bt.indexOf(i.content_id)>-1&&(r=!0,p=lt.repeatContentID),
...
function w(e){
var t=void 0,n=void 0,o=Date.now(),i=e.resp,a=e.loadTime,l=e.forceRefresh,c=document.createDocumentFragment(),s=document.createDocumentFragment();
if(pt=i.only_fans_can_comment,_(lt.handleList,encodeURIComponent(JSON.stringify({
comment_id:gt,
offset:ft,
url:Lt
}))),1!==i.enabled?(Nt&&(Nt.style.display="none"),St&&d(St),i.elected_comment=[],
i.friend_comment=[],i.elected_comment_total_cnt=0,i.friend_comment_total_cnt=0):(Nt&&(Nt.style.display="block"),
St&&m(St)),0===ft){
if(ht=i.logo_url,It=i.nick_name,l&&(Bt=[]),t=i.elected_comment,t&&t.length){
if(y(t,c,"elected"),l&&(bt.list.innerHTML=""),bt.list.appendChild(c),m(bt.main),
...
n=i.friend_comment,y(n,s,"friend"),n&&0===n.length&&d(St),l&&(bt.fdlist.innerHTML=""),
...
}else t=i.elected_comment,t&&t.length&&(y(t,c,"elected"),bt.list.appendChild(c));
...
m(document.getElementById("js_cmt_qa"))):ft+=i.elected_comment.length;
var f=5;
if(t.length>f&&window.has_related_article){
var w=0;
m(bt.showAll),d(document.getElementById("js_cmt_statement"));
for(var h=bt.list.querySelectorAll("li.js_comment_item"),j=0;f>j;j++){
...
bt.listContainer.style.height=w+"px",bt.showAllWording.innerText="查看更多%s条留言".replace("%s",t.length-f);
}
p(),a&&r(a,Date.now()-o);
}
function h(e){
...
try{
Ct++,t&&(vt=[]),Ct>1&&!t&&_(lt.moreList,encodeURIComponent(a)),vt.indexOf(a)>-1&&_(lt.repeatList,encodeURIComponent(a)),
vt.push(a);
}catch(c){
console.error(c);
}
...
forceRefresh:t,
loadTime:Date.now()-l
}):_(lt.errList,"type:resperr;url:"+encodeURIComponent(a)+";ret="+o),mt("[Appmsg comment] get comment success");
},
error:function(){
_(lt.errList,"type:ajaxerr;url:"+encodeURIComponent(a)),mt("[Appmsg comment] get comment ajax error");
},
complete:function(){
...
if(at.log("tag3"),e.length<1)return void l("留言不能为空");
if(at.log("tag4"),e.length>600)return void l("字数不能多于600个");
...
dataType:"json",
success:function(n){
switch(at.log("tag8"),Mt||Ft.hidePannel(),+n.ret){
case 0:
C(n,e);
break;
...
0!==Number(n.ret)&&_(lt.addCommentErr,"type:resperr;url:"+encodeURIComponent(t)+";ret="+n.ret);
},
error:function(e){
at.log("shit;"+e.status+";"+e.statusText),_(lt.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(t));
},
complete:function(){
...
Et=2;
}else Et=0,_(lt.errComment,"type:resperr;url:"+encodeURIComponent(t)+";ret="+n);
},
error:function(){
Et=0,_(lt.errComment,"type:ajaxerr;url:"+encodeURIComponent(t));
},
complete:function(){
d(e),a();
}
...
window.__second_open__&&Q.os.ios&&m(bt.fakebar),window.scrollTo(0,0),B(),e||at.later(function(){
bt.input.focus();
});
}
function I(){
...
for(var o=parseInt(n.dataset.status,10),i=0===o?1:0,m=n.dataset.contentId,d=n.dataset.scene,a=document.querySelectorAll('.js_comment_praise[data-content-id="'+m+'"]'),l=0;l<a.length;l++)x(a[l]);
J({
...
function L(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status,10),o=n?0:1,i=t.dataset.contentId,m=t.dataset.replyId,d=t.dataset.scene,a=document.querySelectorAll('.js_reply_praise[data-content-id="'+i+'"]'),l=0;l<a.length;l++)x(a[l]);
nt({
...
e.preventDefault(),window.__second_open__&&Q.os.ios?k():(At&&console.log("push comment"),
it.push("comment"));
}
}
function N(e){
...
Q.os.ios&&e.data&&Ut.indexOf(e.data)>-1&&(jt=!0);
}),tt.on(bt.input,"click",function(){
Q.os.ios&&jt&&(bt.input.blur(),bt.input.focus(),jt=!1);
...
e.preventDefault();
}),bt.goback&&(tt.on(bt.goback,"click",H),tt.on(bt.goback,"click",H)),window.__second_open__&&Q.os.ios&&!function(){
tt.on(bt.input,"click",function(){
d(bt.fakebar);
...
d(bt.inputPC),m(bt.containerPC),S(bt.containerPC)&&N(bt.containerPC),bt.input.focus();
}),tt.bindVisibilityChangeEvt(function(e){
e&&K.getScrollTop()<X.getOffset(bt.cmtContainer).offsetTop-K.getInnerHeight()&&h({
forceRefresh:!0,
cb:w
});
}),tt.on(bt.showAllWording,"tap",function(e){
e.preventDefault(),d(bt.showAll),m(document.getElementById("js_cmt_statement")),
bt.listContainer.style.height=bt.list.clientHeight+"px";
});
}
function F(){
function e(){
...
var u=void 0,g=V.getRange(),f=Ft.edata,y=document.getElementById("js_length_notice_pc"),w=document.getElementById("js_word_length_pc");
...
function O(t){
if(pt=t.only_fans_can_comment,It=t.nick_name,ct=t.is_fans,ht=t.logo_url,st=t.comment_count,
window._has_comment=!0,!Rt||0===Number(gt))return void(window._has_comment=!1);
if(Nt){
var n=e("appmsg/comment_tpl.html.js"),o=e("appmsg/comment_pc_tpl.html.js");
Nt.innerHTML=ot.tmpl(n,{
new_appmsg:window.new_appmsg
}),zt.insertAdjacentHTML("afterbegin",ot.tmpl(o,{
new_appmsg:window.new_appmsg
}));
}
if(St){
var m=e("appmsg/friend_comment_tpl.html.js");
St.innerHTML=ot.tmpl(m,{
new_appmsg:window.new_appmsg
});
}
...
repeatContent:24,
repeatContentID:23
},ct=void 0,st=void 0,rt=void 0,_t=void 0,pt=void 0,ut=void 0,gt=0,ft=0,yt=void 0,wt=!1,ht="",jt=!1,Ct=0,vt=[],bt={},Bt=[],kt="",It="我",Et=0,Tt={},xt=Date.now(),Dt=100,Lt=location.href,Mt=Q.os.pc,Pt="comment_editing",Ht="my_comment_empty_data",Rt=navigator.userAgent.indexOf("MicroMessenger")>-1,Nt=document.getElementById("js_cmt_area"),St=document.getElementById("js_friend_cmt_area"),zt=document.getElementById("js_cmt_container"),At=Lt.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1,Ft=e(Mt?"appmsg/emotion/emotion_pc.js":"appmsg/emotion/emotion.js"),Ot="http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0",Ut=["“”","‘’","（）","《》","〈〉","「」","『』","〔〕","【】","［］","[]","｛｝","{}","()","<>"];
return window.pageCommentReportData&&window.pageCommentReportData.idkey&&(At&&console.log("init reportData"),
lt=window.pageCommentReportData),"undefined"!=typeof window.comment_id?gt=window.comment_id:window.cgiData&&"undefined"!=typeof window.cgiData.comment_id&&(gt=window.cgiData.comment_id),
Rt||(Nt&&(Nt.style.display="none"),St&&(St.style.display="none"),gt=0),At&&console.info("[图文评论] 评论ID:",gt),
U(),{
initComment:O,
getCommentData:h,
renderComment:w
